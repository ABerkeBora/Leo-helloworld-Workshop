...
import "./App.css";
import helloworld_soho3169 from "../helloworld/build/main.aleo?raw";
...
function App() {
  ...
  async function deploy() {
    setDeploying(true);
    try {
      const result = await aleoWorker.deployProgram(helloworld_soho3169);
        ...
        <p>
          <button disabled={executing} onClick={execute}>
            {executing
              ...
              : `Execute helloworld_soho3169.aleo`}
          </button>
        </p>
        <p>
